#streamlit run C:\Users\haanh\PyCharmMiscProject\Abschluss\Streamlit_Hypertonie.py
#docs.streamlit.io
...
st.page_link(r"C:\Users\haanh\PyCharmMiscProject\Abschluss\Pages\1_Zeitreihenanalyse.py", label="Zeireihenanalyse", icon="🏠")

plumb = st.button(label="page 2")
if plumb == True:
    st.page_link(r"C:\Users\haanh\PyCharmMiscProject\Abschluss\Pages\2_Risikofaktoren.py", label="Page 1", icon="1️⃣")